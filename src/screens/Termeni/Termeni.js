...
function Termeni() {
	return (
		<div className="p-5 text-justify m-5">
			...
			<p>
				...
				please let us know by emailing at <b>roxana@travelingromania.ro</b> so we can try to find a solution.
			...
			<p>
				...
				communications from us by following the unsubscribe link or by emailing at roxana@travelingromania.ro.
			</p>
			<p>
				3. <b>Purchases</b>
			</p>
			...
			<p>
				We issue refunds for Contracts within <b>30 days</b> of the original purchase of the Contract.
			</p>
			<p>
				6. <b>Content</b>
			</p>
			...
			<p>
				TRAVELING ROMANIA SRL has the right but not the obligation to monitor and edit all Content provided by
				users.
			</p>
			<p>
				In addition, Content found on or through this Service are the property of TRAVELING ROMANIA SRL or used
			...
			<p>
				...
				and will remain the exclusive property of TRAVELING ROMANIA SRL and its licensors. Service is protected
				by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in
				connection with any product or service without the prior written consent of TRAVELING ROMANIA SRL.
			</p>
			<p>
			...
			<p>
				...
				roxana@travelingromania.ro, with the subject line: “Copyright Infringement” and include in your claim a
			...
			<p>You can contact our Copyright Agent via email at roxana@travelingromania.ro.</p>
			<p>
				14. <b>Error Reporting and Feedback</b>
			</p>
			<p>
				You may provide us either directly at roxana@travelingromania.ro or via third party sites and tools with
			...
			<p>
				...
				TRAVELING ROMANIA SRL.
			</p>
			<p>
				TRAVELING ROMANIA SRL has no control over, and assumes no responsibility for the content, privacy
			...
			<p>
				...
				<Link to="https://policymaker.io/terms-and-conditions/">Terms of Use</Link> have been created using{' '}
				<Link to="https://policymaker.io/">PolicyMaker.io</Link>, a free web application for generating
				high-quality legal documents. PolicyMaker's
				<Link to="https://policymaker.io/terms-and-conditions/">Terms and Conditions generator</Link> is an
			...
			<p>
				These Terms shall be governed and construed in accordance with the laws of Romania, which governing law
			...
			<p>
				...
				<b>roxana@travelingromania.ro</b>.
			</p>
			<p className="margin-top: 5em; font-size: 0.7em;">
				These <Link to="/termeni">Terms of Service</Link> were created for {' '}
				<b>
					<Link to="/">https://travelingromania.ro/</Link>
				</b>{' '}
				by <Link to="https://policymaker.io"> PolicyMaker.io </Link>
				on 2022-01-01.
			</p>
		</div>
	);
