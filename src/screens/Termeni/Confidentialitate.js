...
function Confidentialitate() {
	return (
		<div className="p-5 text-justify m-5">
			...
			<p>
				Your privacy is important to us. It is TRAVELING ROMANIA SRL&#39;s policy to respect your privacy and
				comply with any applicable law and regulation regarding any personal information we may collect about
				you, including across our website, <NavLink to="/">https://travelingromania.ro/</NavLink>, and other
				sites we own and operate.{' '}
			</p>
			<p>This policy is effective as of 20 May 2022 and was last updated on 20 May 2022. </p>
			...
			<p>
				Traveling Romania<br />
				roxana@travelingromania.ro{' '}
			</p>
		</div>
	);
}
